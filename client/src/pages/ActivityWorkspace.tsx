...
export function ActivityWorkspace() {
  ...
  const saveIntroductionReflection = (record: WorkflowRecord) => {
    ...
    upsertWorkflowRecord({ ...record, status: "completed", introductionReflection: reflection, introductionReflectionAt: new Date().toISOString(), followUpDraft });
    setRecords(getWorkflowRecords());
