...
export function PageIntro({ label, title, copy, note }: { label: string; title: ReactNode; copy: string; note?: ReactNode }) {
  ...
  const routeMark: Record<string, string> = { connect: "01 / MATCH", community: "02 / THREAD", events: "03 / DATE", tools: "04 / WORK", pricing: "05 / MOVE", learn: "06 / FIELD", sponsors: "07 / PARTNER", applications: "08 / APPLY", "demo-day": "09 / SHOW", webinars: "10 / LIVE", workshops: "11 / SHIP", contact: "12 / ROUTE", terms: "13 / TRUST", accessibility: "14 / ACCESS", podcasts: "15 / LISTEN", courses: "16 / COURSE", playbooks: "17 / PLAY", videos: "18 / WATCH", stories: "19 / NOTE", members: "20 / PERSON", requests: "21 / ASK" };
  const routeTrace: Record<string, [string, string, string]> = { community: ["QUESTION", "REPLY", "MOMENTUM"], learn: ["STAGE", "FIELD NOTE", "MOVE"], events: ["DATE", "ROOM", "FOLLOW-UP"], tools: ["INPUT", "WORK", "OUTPUT"], pricing: ["CONSTRAINT", "ACCESS", "MOMENTUM"], providers: ["PRACTICE", "CONTEXT", "INTRO"], support: ["ROUTE", "CONTEXT", "ANSWER"], about: ["PEOPLE", "WORK", "MOMENTUM"], sponsors: ["AUDIENCE", "OUTCOME", "PLACEMENT"], applications: ["CONTEXT", "ROUTE", "REPLY"], "demo-day": ["PROGRESS", "ROOM", "CONVERSATION"], webinars: ["TOPIC", "LIVE ROOM", "FIELD NOTE"], workshops: ["INPUT", "WORKING SESSION", "DELIVERABLE"], contact: ["BLOCKER", "CONTEXT", "ANSWER"], terms: ["PROMISE", "BOUNDARY", "CONTRIBUTION"], accessibility: ["ACCESS", "ADAPT", "PARTICIPATE"], podcasts: ["OPERATOR", "CONTEXT", "TAKEAWAY"], courses: ["STAGE", "PRACTICE", "REPEAT"], playbooks: ["QUESTION", "SEQUENCE", "TEST"], videos: ["WATCH", "NOTE", "APPLY"], stories: ["FIELD NOTE", "PATTERN", "MOVE"], members: ["PERSON", "CONTEXT", "INTRO"], requests: ["ASK", "CONTEXT", "RESPONSE"] };
