  ...
  /><header className="site-header workspace-header landing-site-header">
    <div className="container nav-row landing-header-row">
      ...
      <div className="nav-actions">
        ...
        <Link href="/dashboard/profile" className="avatar-button" aria-label={t("Open profile", "فتح الملف الشخصي")}>{founderInitials(getFounderProfile().name)}</Link>
